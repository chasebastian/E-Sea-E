...
class Pedometer:
  ...
  __thresh_low = 2   # Threshold from Tutorial 2
  __thresh_high = 200 # Threshold from Tutorial 2
  ...
  def process(self):
    ...
    #Added edits to our algorithm
    #We looked at the peaks in the gradient of the accelerometer to detect movement
    x = filt.gradient(x)
